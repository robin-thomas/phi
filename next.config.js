module.exports = {
  env: {
    APP_NAME: 'Phi',
    ALCHEMY_URL: 'https://eth-rinkeby.alchemyapi.io/v2/',
    CERAMIC_NODE_URL: 'https://ceramic-clay.3boxlabs.com',
    CERAMIC_NETWORK: 'testnet-clay',
    ETH_CHAIN_ID: '0x4',
    ETH_CHAIN_NAME: 'Rinkeby',
    MORALIS_APP_ID: '42xWdrMzGqEzjNbXMfpHWCr56iSg4qEUfJ8bTtc7',
    MORALIS_SERVER_URL: 'https://gkvtzty6ii8i.usemoralis.com:2053/server',
